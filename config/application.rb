...
module Gitlab
  class Application < Rails::Application
    ...
    config.autoload_paths += %W(#{config.root}/lib #{config.root}/app/services #{config.root}/app/models/concerns)

    config.middleware.use "Gitlab::Event::Hierarchy::Middleware"
