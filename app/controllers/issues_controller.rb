class IssuesController < ProjectResourceController
  ...
  def bulk_update
    result = Projects::Issues::BulkUpdateContext.new(project, current_user, params).execute
  ...
  def issues_filtered
    @issues = Projects::Issues::ListContext.new(project, current_user, params).execute
  end
end
